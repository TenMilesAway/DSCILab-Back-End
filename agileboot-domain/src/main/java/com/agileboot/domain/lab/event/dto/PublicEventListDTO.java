...
@Schema(description="\u516c\u5f00\u6d3b\u52a8\u5217\u8868\u9879")
public class PublicEventListDTO {
    private Long id;
    private String title;
    private String summary;
    private LocalDate eventTime;

    public static PublicEventListDTO fromLabList(LabEventListDTO dto) {
        PublicEventListDTO item = new PublicEventListDTO();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PublicEventListDTO)) {
            return false;
        }
        PublicEventListDTO other = (PublicEventListDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PublicEventListDTO;
    }
    ...
    public String toString() {
        return "PublicEventListDTO(id=" + this.getId() + ", title=" + this.getTitle() + ", summary=" + this.getSummary() + ", eventTime=" + this.getEventTime() + ")";
    }
}
