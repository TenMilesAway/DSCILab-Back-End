...
--
-- Table structure for table `lab_achievement_author`
--

DROP TABLE IF EXISTS `lab_achievement_author`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lab_achievement_author` (
...
--
-- Dumping data for table `lab_achievement_author`
--

LOCK TABLES `lab_achievement_author` WRITE;
/*!40000 ALTER TABLE `lab_achievement_author` DISABLE KEYS */;
INSERT INTO `lab_achievement_author` VALUES (1,9,NULL,'佟强','Tong Qiang',NULL,1,1,NULL,1,'2025-09-03 20:06:23','2025-09-03 20:06:23',0,1,NULL),(2,9,NULL,'谢志超','Xie Zhichao',NULL,2,0,NULL,1,'2025-09-03 20:06:23','2025-09-03 20:06:23',0,1,NULL);
/*!40000 ALTER TABLE `lab_achievement_author` ENABLE KEYS */;
UNLOCK TABLES;
